...
/// Сохраняет одно изменённое поле обратно в config.toml, сохраняя форматирование файла
pub fn save_field(toml_path: &str, new_value: &str) -> Result<(), String> {
    ...
    // Определяем тип значения: если поле было числом/bool — парсим как таковое,
