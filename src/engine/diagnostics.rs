...
///
/// 6: `tls_record` режет имя на записи по три символа, а не на две
/// половины (см. `tls::split_into_records`). Там, где половина имени
/// содержала запрещённое слово (youtubei.googleapis.com), техника
/// проваливалась — вердикты версии 5 для таких доменов ложные `resigned`.
pub const DIAGNOSTIC_VERSION: u32 = 6;
